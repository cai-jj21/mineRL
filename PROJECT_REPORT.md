...
最终模型/集成策略的模型卡见 `MODEL_CARD.md`，消融与对照证据见 `ABLATION_STUDY.md`，完成度审计见 `PROJECT_COMPLETION_AUDIT.md`，评估口径见 `EVALUATION_PROTOCOL.md`，面试答辩问答见 `INTERVIEW_QA.md`，checkpoint 与本地实验产物说明见 `ARTIFACTS.md`，系统分层和证据链总览见 `ARCHITECTURE.md`。
...
- 面试答辩问答：[INTERVIEW_QA.md](INTERVIEW_QA.md)
- 消融与对照研究：[ABLATION_STUDY.md](ABLATION_STUDY.md)
- 完成度审计：[PROJECT_COMPLETION_AUDIT.md](PROJECT_COMPLETION_AUDIT.md)
