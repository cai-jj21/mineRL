...
最终模型/集成策略的模型卡见 `MODEL_CARD.md`，消融与对照证据见 `ABLATION_STUDY.md`，完成度审计见 `PROJECT_COMPLETION_AUDIT.md`，评估口径见 `EVALUATION_PROTOCOL.md`，checkpoint 与本地实验产物说明见 `ARTIFACTS.md`，系统分层和证据链总览见 `ARCHITECTURE.md`。
