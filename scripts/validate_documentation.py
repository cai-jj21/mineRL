...
REQUIRED_FILES = [
    ...
    Path("sql/warehouse_analysis.sql"),
]
...
REQUIRED_MENTIONS = {
    ...
    "DATA_DEVELOPMENT_CASE.md": [
        ...
        "scripts/generate_training_feedback_plan.py",
        "scripts/export_training_feedback_dataset.py",
        "per_game_summary.json",
        "minesweeper_experiments.sqlite",
        "database_analysis.md",
        "database_analysis.json",
        "training_feedback_plan.json",
        "training_feedback_plan.md",
        "training_feedback_dataset.json",
        "training_feedback_dataset.jsonl",
        "training_feedback_dataset.md",
        "claim_audit.json",
        ...
        "source_file",
        "diagnostic_runs",
        "diagnostic_game_detail",
        "diagnostic_signal",
        "diagnostic_recommendation",
        "failure_analysis_run",
        "failure_endgame_bucket",
        "failure_exact_limit",
        "v_ods_source_inventory",
        "v_dwd_game_session",
        "v_dwd_action_event",
        "v_dws_run_kpi",
        "v_ads_experiment_dashboard",
        "v_ads_diagnostic_signal_profile",
        "v_ads_failure_training_signal",
        "sql/warehouse_analysis.sql",
        "43.0%",
        "40.40%",
        "39.60%",
...
def check_artifact_manifest_mentions(root: Path) -> list[DocumentationCheck]:
    ...
    expected_mentions = {
        "REPRODUCIBILITY.md": f"`{artifact_count}`",
